...
import { IAccountRegisterDto } from '@/modules/Account/@types/account.dto'
import { registerHandler } from '@/modules/Account/Handler/account.handler'
...
const RegisterView = () => {
  ...
  async function onSubmit(data: IAccountRegisterDto) {
    try {
      setLoading(true)
      const res = await registerHandler(data, getAccount())
      setAccount(res)
      navigate('/dashboard')
